...
<body>
	...
	<form:form action="registerUser" method="post" modelAttribute="user">
		<div class="container" align="left">
			...
			<form:input path="firstName" type="text" placeholder="Enter First Name" id="firstname" required="required" />
			<form:errors path="firstName" cssClass="text-warning"/>
			<br /> 
			<label for="lastname"><b>Last Name:</b></label> 
			<input type="text" name="lastName" placeholder="Enter Last Name" id="lastName" required="required" /><br />
			<label for="username"><b> User Name:</b> </label>
			<input type="text" name="email" placeholder="Enter Email" id="email" required="required" /><br /> 
			<label for="password"><b>Password:</b></label>
			<input type="password" name="password" placeholder="Enter Password" id="password" required="required" /><br />
			<label for="confirm password"><b>Confirm password:</b></label>
			<input type="password" name="Confirm Password" placeholder="Enter Password once again" id="password repeat" required="required" /><br /> <br />
			<hr>
			<p>
